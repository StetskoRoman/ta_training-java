...
class ReadTextFileAndChange {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Scanner scanner = new Scanner(new File("src/com/epam/training/student_Roman_Stecko/JavaCollections/JavaCollections_OptionalTasks/poem.txt"));
        ...
        try (BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter("src/com/epam/training/student_Roman_Stecko/JavaCollections/JavaCollections_OptionalTasks/poemReverse.txt")))
        {
